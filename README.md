...
1. Descargamos desde la página de [Osboxes](https://www.osboxes.org/ubuntu/) Ubuntu 22.04. Un vez instalado, abrimos VirtualBox y le damos a la opción "Crear" y le ponemos un nombre a la máquina, en este caso "Ubuntu 2".
